<template>
    <div>
        ...
        <div class="bg-gray-100 flex justify-center items-center h-screen">
            <!-- Left: Image -->
            <div class="w-3/5 h-screen hidden lg:block">
                <img src="/img/clinicaofta.png"
                    alt="Placeholder Image" class="object-cover w-full h-full">
            </div>
            <!-- Right: Login Form -->
            <div class=" py-12 px-16 sm:20 w-full lg:w-2/5">
                <h1 class="text-2xl font-semibold mb-1">Sistema información</h1>
                <p class="text-gray-600 mb-3">Accede a tu cuenta para gestionar tu información.</p>
                <div>
                    <div>
                        <a href="/login"
                ...
                <div class="mt-6 text-blue-500 text-center">
                    <a href="#" class="hover:underline flex justify-center items-center gap-1">
                        ...
                        <span class="text-black ">Necesito ayuda</span>
                    </a>
                </div>
            </div>
        </div>
